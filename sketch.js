...
document.getElementById("instructions").style.color = instructions[palette[index]];
...
recognition.onspeechend = function() {
  recognition.stop();
  document.getElementById("log").innerHTML = " ";  
  document.getElementById("instructions").innerHTML = "Welcome to An Array of Constraint. Style type with your voice by pressing a key and start speaking.";
